        ...
        buttons: [ {
            ...
            listeners: {
                click: function(b, e) {
                    ...
                    // delete from store
                    GEOR.Addons.Cadastre.result.tabs.activeTab.store.remove(GEOR.Addons.Cadastre.result.tabs.activeTab.getSelectionModel().getSelected());
                    // delete from select feature
            ...
            listeners: {
                click: function(b, e) {
                    // Open details frame of selected plots
                }
            }
        },{
