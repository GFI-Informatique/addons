...
GEOR.FeaturePanel = Ext.extend(Ext.form.FormPanel, {
    ...
    initMyItems: function() {
        ...
        if (feature.geometry.CLASS_NAME === "OpenLayers.Geometry.Point" ) {
            if (!feature.isLabel) {
                ...
                oItems.push({
                    xtype: 'spinnerfield',
                    name: 'pointRadius',
                    fieldLabel: OpenLayers.i18n('cadastrapp.size'),
        ...
        if (feature.isLabel) {
            oItems.push({
                name: 'label',
                fieldLabel: OpenLayers.i18n('cadastrapp.label'),
        ...
        if (feature.geometry.CLASS_NAME !== "OpenLayers.Geometry.LineString" &&
            ...
            oItems.push({
                ...
                fieldLabel: OpenLayers.i18n('cadastrapp.fillcolor'),
                items: [{
        ...
        var label = (
            ...
            feature.isLabel
        ) ? 'cadastrapp.color' : 'cadastrapp.outlinecolor';
        oItems.push({
            xtype: 'compositefield',
        ...
        if (feature.geometry.CLASS_NAME !== "OpenLayers.Geometry.Point" ||
            ...
            oItems.push({
                xtype: 'spinnerfield',
                name: 'stroke',
                fieldLabel: OpenLayers.i18n('cadastrapp.' + attribute.toLowerCase()),
    ...
    initDeleteAction: function() {
        var actionOptions = {
            ...
            scope: this,
            tooltip: OpenLayers.i18n('cadastrapp.delete_feature'),
            iconCls: "gx-featureediting-delete",
            text: OpenLayers.i18n('cadastrapp.delete')
        };
    ...
    deleteFeatures: function() {
        ...
        Ext.MessageBox.confirm(OpenLayers.i18n('cadastrapp.delete_feature'), OpenLayers.i18n('cadastrapp.delete_confirm'), function(btn) {
            if (btn == 'yes') {
