...
// créer le control de selection et la couche des parcelle à partir du wfs et
// appliquer le control à la couche
...
getFeaturesWFSSpatial = function(typeGeom, coords, typeSelector) {
    ...
    Ext.Ajax.request({
        ...
        success : function(response) {
            ...
            var idField = WFSLayerSetting.nameFieldIdParcelle; // champ
                                                                // identifiant
                                                                // de parcelle
                                                                // dans
                                                                // geoserver
